...
export default function Contact({ business }: ContactProps) {
  ...
  return (
    <section id="contacto" className="py-24 px-4 bg-[var(--color-dark)]/95 backdrop-blur-md">
      <div className="max-w-6xl mx-auto">
                ...
                <motion.div variants={fadeInUp} className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a
                      ...
                      className="text-white/70 hover:text-[var(--color-turquoise)] transition-colors"
                    >
                      {business.phone}
                    </a>
                  </div>
        ...
        >
          <a
            ...
            className="inline-flex items-center gap-3 px-8 py-4 bg-[var(--color-whatsapp)] hover:bg-[var(--color-whatsapp-dark)] text-white font-semibold rounded-xl transition-colors duration-200 shadow-lg shadow-[var(--color-whatsapp)]/30"
          >
