      ...
      <div className="max-w-6xl mx-auto">
          ...
          >
            <div className="space-y-6">
                ...
                >
                  ...
                  <div>
                    ...
                    <a
                      ...
                      className="text-white/90 hover:text-[var(--color-turquoise)] transition-colors"
                    >
                      {business.phone}
                    </a>
                  </div>
              ...
              >
                ...
                <div>
                  <h3 className="font-semibold mb-1 text-white">Horarios</h3>
        ...
        >
          <motion.a
            ...
            className="inline-flex items-center gap-3 px-8 py-4 bg-white hover:bg-gray-100 text-[var(--color-whatsapp)] border-2 border-[var(--color-whatsapp)] font-semibold rounded-xl transition-colors duration-200 shadow-lg shadow-black/10"
          >
